...
python -u /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/test_fusion.py --config /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/configs/fusion/scene3d.yaml
