...
python -u /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/train_fusion.py --config /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/configs/fusion/corbs_euler.yaml
