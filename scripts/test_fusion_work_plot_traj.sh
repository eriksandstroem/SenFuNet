...
python -u /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/test_fusion_plot_metric_over_trajectory.py --config /cluster/project/cvl/esandstroem/src/late_fusion_3dconvnet/configs/fusion/replica_euler.yaml
