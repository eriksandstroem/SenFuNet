...
class FusionNet(nn.Module):
    def __init__(self, config, sensor):
        ...
        self.block2 = nn.Sequential(
            nn.Conv2d(2 * self.n_channels, self.n_channels, (3, 3), padding=1),
            nn.BatchNorm2d(self.n_channels),
            nn.LeakyReLU(),
            nn.Dropout2d(p=0.2),
            nn.Conv2d(self.n_channels, self.n_channels, (3, 3), padding=1),
        ...
        self.block3 = nn.Sequential(
            nn.Conv2d(3 * self.n_channels, self.n_channels, (3, 3), padding=1),
            nn.BatchNorm2d(self.n_channels),
            nn.LeakyReLU(),
            nn.Dropout2d(p=0.2),
            nn.Conv2d(self.n_channels, self.n_channels, (3, 3), padding=1),
        ...
        self.block4 = nn.Sequential(
            nn.Conv2d(4 * self.n_channels, self.n_channels, (3, 3), padding=1),
            nn.BatchNorm2d(self.n_channels),
            nn.LeakyReLU(),
            nn.Dropout2d(p=0.2),
            nn.Conv2d(self.n_channels, self.n_channels, (3, 3), padding=1),
        ...
        self.pred1 = nn.Sequential(
            nn.Conv2d(5 * self.n_channels, 4 * self.n_channels, (1, 1), padding=0),
        ...
        self.pred2 = nn.Sequential(
            nn.Conv2d(4 * self.n_channels, 3 * self.n_channels, (1, 1), padding=0),
        ...
        self.pred3 = nn.Sequential(
            nn.Conv2d(3 * self.n_channels, 2 * self.n_channels, (1, 1), padding=0),
        ...
        self.pred4 = nn.Sequential(
            nn.Conv2d(2 * self.n_channels, 1 * self.n_channels, (1, 1), padding=0),
            nn.BatchNorm2d(self.n_channels),
            nn.LeakyReLU(),
            nn.Dropout2d(p=0.2),
