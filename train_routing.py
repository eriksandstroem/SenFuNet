...
def train(args, config):
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset, config.TRAINING.train_batch_size, config.TRAINING.train_shuffle)
    ...
    for epoch in range(0, config.TRAINING.n_epochs):
        ...
        workspace.log('Epoch {} Validation L1 Loss {}'.format(epoch, val_loss_l1), mode='val')
        workspace.log('Epoch {} Validation L2 Loss {}'.format(epoch, val_loss_l2), mode='val')
